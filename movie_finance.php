...
require 'connection.php';
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$connect){
        ...
        $sql = "INSERT INTO `finance_department` (`movie_id`,`prod_comp_id`,`budget`,`collection`) VALUES ('$aid','$aname', '$ag','$coll')";
...
<h1>MOVIE FINANCE TABLE INSERTION</h1>
    <form action="movie_finance.php" method="post">
