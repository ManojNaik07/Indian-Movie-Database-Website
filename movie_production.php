...
require 'connection.php';
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$connect){
        ...
        $sql = "INSERT INTO `production_company` (`company_id`,`company_name`) VALUES('$pid', '$pname')";
...
<h1>PRODUCTION COMPANY TABLE INSERTION</h1>
    <form action="movie_production.php" method="post">
    
    <div class="form-group">
        <label for="production name">Production Company ID</label>
        <input type="text" name="aaa" class="form-control" id="aaa">
    </div>

    <div class="form-group">
        <label for="Movie Title">Production Company Name</label>
