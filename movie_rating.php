...
require 'connection.php';
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$connect){
        ...
        $sql = "INSERT INTO `rating` (`rating_id`,`movie_id`,`rating`) VALUES('$rid','$mid', '$rating')";
...
<h1>FILL THE DETAILS TO REDUCE UR WORK...:)))</h1>
    <form action="movie_rating.php" method="post">

    <div class="form-group">
        <label for="Movie ID">Rating ID</label>
