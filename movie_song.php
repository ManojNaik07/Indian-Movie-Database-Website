...
require 'connection.php';
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$connect){
        ...
        $sql = "INSERT INTO `songs` (`song_id`,`song_name`,`movie_id`) VALUES ('$sid','$mid','$sname')";
...
<h1>SONG TABLE INSERTION</h1>
    <form action="movie_song.php" method="post">
    ...
    <div class="form-group">
        <label for="Movie ID">Song Name</label>
        <input type="text" name="bbb" class="form-control" id="bbb"> 
    </div>
    
    <div class="form-group">
        <label for="Song Name">Movie ID</label>
